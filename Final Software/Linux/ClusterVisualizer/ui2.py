...
try:
	...
	tkMessageBox.showinfo("File Missing!","Network File Not Found! Place the file with proper name and run the program again")
	sys.exit()
...
def add():
	...
	try:
		...
		tkMessageBox.showinfo("Wrong Input Format(Number of Nodes)","Please Enter a single integer value between 1 and 1000")
		return	
	try:
		e=float(ep.get())
	except Exception,e:
		tkMessageBox.showinfo("Wrong Input Format for e","Please Enter a single float value between 0 and 1")
		return
	try:
		MU=float(mu.get())
	except Exception,e:
		tkMessageBox.showinfo("Wrong Input Format for Mu","Please Enter a integer value greater than 0")
		return	
...
def series():
	...
	try:
		...
		tkMessageBox.showinfo("Wrong Input for Time Series","Please Input Space Seperated Integer Values (At least 1 value)")	
	xar=[]
